...
The NCAA SEC is one of the premier conferences in college football from recent years, but how much is each program represented in the draft? We collected our data from Pro-Football-Reference.com and combined each program in the SEC data sets into a singular Excel file and analyzed the data by distinguishing which players came from which college program, seeing if the player was drafted, then drafted within the years 2011-2025. As of now the results express how big name schools within the conference (i.e. Alabama, Georgia, Texas) all show steady growth within the year 2011-2025 time frame. Our analyses can help students looking to play football within the SEC decide on what program they want to play for. Either an established program where they will have to fight for a roster spot or a rising program where they can compete to win the conference against the elite programs.
...
Riccardo Gutierrez: Gathered data sets, completed abstract section, contributed to data and analysis sections.
